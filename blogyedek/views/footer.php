...
<!--Plugins-->
<script src="<?php echo URL;; ?>/dosyalar/js/jquery.js"></script>
<script src="<?php echo URL;; ?>/dosyalar/js/plugins.js"></script>
<!--Template functions-->
<script src="<?php echo URL;; ?>/dosyalar/js/functions.js"></script>
</body>
